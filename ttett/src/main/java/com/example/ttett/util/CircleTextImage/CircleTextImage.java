...
public class CircleTextImage extends ImageView {
    ...
    private int mCircleColor;//Default background color
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typedArray.getColor(R.styleable.circletextview_circle_color, mCircleColor);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null != mText && !mText.trim().equals("")) {
            mPaintTextBackground.setColor(mCircleColor);
