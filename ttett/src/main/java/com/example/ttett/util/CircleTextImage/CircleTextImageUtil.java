package com.example.ttett.util.CircleTextImage;
...
public class CircleTextImageUtil {
    private static class CircleTextImageUtilHolder {
        private static final com.example.ttett.util.CircleTextImage.CircleTextImageUtil INSTANCE = new com.example.ttett.util.CircleTextImage.CircleTextImageUtil();
    }
    private CircleTextImageUtil (){}
    public static final com.example.ttett.util.CircleTextImage.CircleTextImageUtil getInstance() {
        return com.example.ttett.util.CircleTextImage.CircleTextImageUtil.CircleTextImageUtilHolder.INSTANCE;
    }
